...
//        profileTracker.stopTracking();
    ...
    private void nextActivity(Profile profile) {
        if (profile != null) {
            launchActivity(profile.getFirstName());
        }
    }
...
//        startActivity(main);
    ...
    //google plus login changes over here
    ...
    private void updateUI(boolean isSignedIn, String name) {
        if (isSignedIn) {
            launchActivity(name);
        } else {
