...
public class PhotoProofsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new moreListView("ic_profile.png", "Photo", "IDENTITY PROOF"));
        items.add(new moreListView("ic_profile.png", "PAN Card", "IDENTITY PROOF"));
        items.add(new moreListView("ic_profile.png", "Employee Badge", "IDENTITY PROOF"));
        items.add(new moreListView("ic_profile.png", "Salary Slip", "BANK PROOF"));
        items.add(new moreListView("ic_profile.png", "Bank Statements", "BANK PROOF"));
        items.add(new moreListView("ic_profile.png", "Tap here to add proof", "RESIDENTIAL PROOF"));
